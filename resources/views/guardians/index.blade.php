@extends('layout.header') @section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Edit Guardian</h4>
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/guardians/create" class="btn btn-sm btn-success"><i class="fa fa-plus text-white"></i>
                                Guardian</a></h2>
                                        ...
                                        <tbody>
                                            @foreach ($guardians as $guardian)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $guardian->tell }}</td>
                                                    <td>{{ $guardian->family_link }}</td>
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target=".bs-example-modal-lg"
                                                            onclick="initializeIframe('{{ route('guardians.edit', $guardian->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $guardian->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/guardians/" + id + "/delete";
        }
