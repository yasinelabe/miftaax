                ...
                <div class="x_panel">
                    ...
                    <div class="x_content"><br />
                        <form enctype="multipart/form-data" data-parsley-validate
                            ...
                            action="{{ route('gradings.store') }}">@csrf<div class="item form-group"><label
                                    class="col-form-label col-md-3 col-sm-3 label-align" for="exam_type_id">Exam type
                            ...
                            <div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align"
                                ...
                                <div class="col-sm-6"><input type="text" id="from_marks" name="from_marks"
                                        required="required" class="form-control "></div>
                            </div>
                            <div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="to_marks">To marks <span class="required">*</span></label>
                                <div class="col-sm-6"><input type="text" id="to_marks" name="to_marks"
                                        required="required" class="form-control "></div>
                            </div>
                            <div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="grade">Grade <span class="required">*</span></label>
                                <div class="col-sm-6"><input type="text" id="grade" name="grade"
                                        required="required" class="form-control "></div>
                            </div>
                            <div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="grade">Points <span class="required">*</span></label>
                                <div class="col-sm-6"><input type="text" id="points" name="points"
                                        required="required" class="form-control "></div>
                            </div>
