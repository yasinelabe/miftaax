                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form enctype="multipart/form-data" data-parsley-validate
                            ...
                            action="{{ route('book_categories.store') }}">@csrf<div class="item form-group"><label
                            ...
                            <div class="item form-group"><label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="rack_id">Rack <span class="required">*</span></label>
                                <div class="col-sm-6"><select class="form-control" name="rack_id">
                                        <option value="">Select Rack </option>
                                        @foreach ($rack_ids as $rack_id)
                                            <option value="{{ $rack_id->id }}">{{ $rack_id->name }}</option>
                                        @endforeach
                                    </select></div>
                            </div>
