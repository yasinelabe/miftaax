@extends('layout.header') @section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/books/create" class="btn btn-sm btn-success"><i class="fa fa-plus text-white"></i>
                                Book</a></h2>
                                            ...
                                            @foreach ($books as $book)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            ...
                                                            onclick="initializeIframe('{{ route('books.edit', $book->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $book->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/books/" + id + "/delete";
        }
