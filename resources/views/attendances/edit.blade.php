            ...
            <div class="x_panel">
                ...
                <div class="x_content"><br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST"
                        action="{{ route('attendances.update', $attendance->id) }}">@csrf @if (Session::has('success'))
                            <div class="row">
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-sm-12" for="attendance_date">Attendance
                                date <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-sm-12"><input type="date"
                                    value="{{ $attendance->attendance_date }}" id="attendance_date"
                                    name="attendance_date" required="required" class="form-control"></div>
                        </div>
                        <div class="item form-group"><label class="control-label col-md-3 col-sm-3 col-sm-12"
                            ...
                            <div class="col-md-6 col-sm-6 col-sm-12"><select class="form-control" name="class_room_id">
