@extends('layout.header') @section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/attendances/create" class="btn btn-sm btn-success"><i
                                    class="fa fa-plus text-white"></i> Attendance</a></h2>
                                        ...
                                        <tbody>
                                            @foreach ($attendances as $attendance)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $attendance->class_room->name }}</td>
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target=".bs-example-modal-lg"
                                                            onclick="initializeIframe('{{ route('attendances.edit', $attendance->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $attendance->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/attendances/" + id + "/delete";
        }
