@extends('layout.header') @section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Edit ExamType</h4>
    ...
    <div class="modal fade" id="warningModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content" method="get" id="delete">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this ExamType?</p>
                </div>
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/exam_types/create" class="btn btn-sm btn-success"><i
                                    class="fa fa-plus text-white"></i> ExamType</a></h2>
                                            ...
                                            @foreach ($exam_types as $examtype)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            ...
                                                            onclick="initializeIframe('{{ route('exam_types.edit', $examtype->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $examtype->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/exam_types/" + id + "/delete";
        }
