                ...
                <div class="x_content"><br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST"
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-sm-12" for="attendance_id">Attendance
                                <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-sm-12"><select class="form-control" name="attendance_id">
                                    <option value="">Select Attendance </option>
                                    @foreach ($attendance_ids as $attendance_id)
                                        <option value="{{ $attendance_id->id }}">
                                            {{ $attendance_id->attendance_date . '-' . $attendance_id->class_room->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="item form-group"><label class="control-label col-md-3 col-sm-3 col-sm-12"
                            ...
                            <div class="col-md-6 col-sm-6 col-sm-12"><select class="form-control"
                                    name="attendance_result_status_id">
