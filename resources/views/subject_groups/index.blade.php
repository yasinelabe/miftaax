@extends('layout.header') @section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Edit SubjectGroup</h4>
    ...
    <div class="modal fade" id="warningModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content" method="get" id="delete">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this SubjectGroup?</p>
                </div>
        ...
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            <a href="/subject_groups/create" class="btn btn-sm btn-success"><i
                                    class="fa fa-plus text-white"></i> Subject Group</a>
                            <a href="/subject_group_items/create" class="btn btn-sm btn-success"><i
                                    class="fa fa-plus text-white"></i> Subject Group Item</a>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            @foreach ($subject_groups as $subjectgroup)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            ...
                                                            onclick="initializeIframe('{{ route('subject_groups.edit', $subjectgroup->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $subjectgroup->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/subject_groups/" + id + "/delete";
        }
