@extends('layout.header') @section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Edit TeacherSubject</h4>
    ...
    <div class="modal fade" id="warningModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content" method="get" id="delete">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this TeacherSubject?</p>
                </div>
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/teacher_subjects/create" class="btn btn-sm btn-success"><i
                                    class="fa fa-plus text-white"></i> TeacherSubject</a></h2>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            @foreach ($teacher_subjects as $teachersubject)
                                                <tr role="row" class="odd">
                                                    <td>{{ $teachersubject->id }}</td>
                                                    <td>{{ $teachersubject->teacher->fullname }}</td>
                                                    <td>{{ $teachersubject->subject->name .'('.$teachersubject->subject->code.')' }}</td>
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target=".bs-example-modal-lg"
                                                            onclick="initializeIframe('{{ route('teacher_subjects.edit', $teachersubject->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $teachersubject->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/teacher_subjects/" + id + "/delete";
        }
