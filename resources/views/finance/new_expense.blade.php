            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form action="/finance/store_expense" method="post" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-3">
                                        <a href="/finance/new_expense_category" class="btn btn-sm btn-success">New</a>
                                    </div>
                                </div>
