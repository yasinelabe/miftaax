@extends('layout.header') @section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/subjects/create" class="btn btn-sm btn-success"><i class="fa fa-plus text-white"></i>
                                Subject</a></h2>
                                            ...
                                            @foreach ($subjects as $subject)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            ...
                                                            onclick="delete_id({{ $subject->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/subjects/" + id + "/delete";
        }
