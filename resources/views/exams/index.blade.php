@extends('layout.header') @section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/exams/create" class="btn btn-sm btn-success"><i class="fa fa-plus text-white"></i>
                                Exam</a></h2>
                                            ...
                                            @foreach ($exams as $exam)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            ...
                                                            onclick="initializeIframe('{{ route('exams.edit', $exam->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $exam->id }})"> <i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/exams/" + id + "/delete";
        }
