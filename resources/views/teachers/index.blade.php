@extends('layout.header') @section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/teachers/create" class="btn btn-sm btn-success"><i class="fa fa-plus text-white"></i>
                                Teacher</a></h2>
                                        ...
                                        <tbody>
                                            @foreach ($teachers as $teacher)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $teacher->tell }}</td>
                                                    <td>{{ $teacher->blood_group->name }}</td>
                                                    <td>
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            ...
                                                            onclick="initializeIframe('{{ route('teachers.edit', $teacher->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $teacher->id }})"><i
    ...
    <script>
        function delete_id(id) {
            document.getElementById("delete").action = "/teachers/" + id + "/delete";
        }
