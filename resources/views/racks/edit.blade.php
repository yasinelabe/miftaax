            ...
            <div class="x_panel">
                ...
                <div class="x_content"><br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST"
                        action="{{ route('racks.update', $rack->id) }}">@csrf @if (Session::has('success'))
                            <div class="row">
                        ...
                        <div class="item form-group"><label class="control-label col-md-3 col-sm-3 col-sm-12"
                            ...
                            <div class="col-md-6 col-sm-6 col-sm-12"><input type="text" value="{{ $rack->name }}"
                        ...
                        <div class="item form-group"><label class="control-label col-md-3 col-sm-3 col-sm-12"
                            ...
                            <div class="col-md-6 col-sm-6 col-sm-12"><input type="text"
                                    value="{{ $rack->total_rows }}" id="total_rows" name="total_rows"
                                    required="required" class="form-control"></div>
                        </div>
                        <div class="item form-group"><label class="control-label col-md-3 col-sm-3 col-sm-12"
                                for="total_columns">Total columns <span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-sm-12"><input type="text"
                                    value="{{ $rack->total_columns }}" id="total_columns" name="total_columns"
                                    required="required" class="form-control"></div>
                        </div>
