        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Edit ExamGroupItem</h4>
    ...
    <div class="modal fade" id="warningModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content" method="get" id="delete">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this ExamGroupItem?</p>
                </div>
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><a href="/exam_group_items/create" class="btn btn-sm btn-success"><i
                                    class="fa fa-plus text-white"></i> ExamGroupItem</a></h2>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <table id="datatable-buttons"
                                        ...
                                        <tbody>
                                            @foreach ($exam_group_items as $examgroupitem)
                                                <tr role="row" class="odd">
                                                    <td>{{ $examgroupitem->id }}</td>
                                                    <td>{{ $examgroupitem->exam_group->name }}</td>
                                                    <td>{{ $examgroupitem->exam->name }}</td>
                                                    <td>{{ $examgroupitem->academic_year->name }}</td>
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target=".bs-example-modal-lg"
                                                            onclick="initializeIframe('{{ route('exam_group_items.edit', $examgroupitem->id) }}')"><i
                                                                class="fa fa-pencil"></i> Edit </a> | <a
                                                            href="javascript:void(0)" data-toggle="modal"
                                                            data-target="#warningModal"
                                                            onclick="delete_id({{ $examgroupitem->id }})"><i
