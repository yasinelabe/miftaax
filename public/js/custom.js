...
function init_charts() {
        ...
        var lineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "Paid Fees",
                        backgroundColor: "rgba(38, 255, 154, 0.31)",
                        borderColor: "rgba(38, 185, 154, 0.7)",
                        pointBorderColor: "rgba(38, 185, 154, 0.7)",
                        pointBackgroundColor: "rgba(38, 185, 154, 0.7)",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: "rgba(220,220,220,1)",
                        pointBorderWidth: 1,
                        data: JSON.parse(document.getElementById('payment_charts').value),
                    },
                    {
                        label: "Invoiced Fees",
                        backgroundColor: "rgba(255, 88, 106, 0.3)",
                        borderColor: "rgba(3, 88, 106, 0.70)",
                        pointBorderColor: "rgba(3, 88, 106, 0.70)",
                        pointBackgroundColor: "rgba(3, 88, 106, 0.70)",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: "rgba(151,187,205,1)",
                        pointBorderWidth: 1,
                        data: JSON.parse(document.getElementById('invoice_charts').value),
                    },
                ],
            },
        });
    ...
    if ($("#canvasDoughnut").length) {
        ...
        let total_net_income =
            document.getElementById("total_net_income").value;
        let total_net_income_percentage = (total_net_income * 100) / equity;

        let equity_percentage = (equity * 100) / 360;
        let total_net_income_percentage_360 =
            (total_net_income_percentage * 100) / 360;

        if (total_net_income_percentage_360 < 0) {
            total_net_income_percentage_360 =
                total_net_income_percentage_360 * -1;
            bg = "#FF0000";
            bghover = "#FF0000";
        }
        ...
        var data = {
            labels: ["Equity", "Profit/Loss"],
            datasets: [
                {
                    data: [equity_percentage, total_net_income_percentage_360],
                    backgroundColor: ["#BDC3C7", bg],
                    hoverBackgroundColor: ["#CFD4D8", bghover],
                },
            ],
        };
